...
module NewWxPay
  module Service
    ...
    def self.generate_authorize_url(redirect_uri, state = nil)
      ...
      "https://open.weixin.qq.com/connect/oauth2/authorize?appid=#{NewWxPay.appid}&redirect_uri=#{CGI::escape redirect_uri}&response_type=code&scope=snsapi_base&state=#{state}"
    end

    def self.authenticate(authorization_code, options = {})
      options = NewWxPay.extra_rest_client_options.merge(options)
      payload = {
        appid: options.delete(:appid) || NewWxPay.appid,
        secret: options.delete(:appsecret) || NewWxPay.appsecret,
    ...
    def self.get_sandbox_signkey(mch_id = NewWxPay.mch_id, options = {})
      params = {
        mch_id: mch_id,
        key: options.delete(:key) || NewWxPay.key,
        nonce_str: SecureRandom.uuid.tr('-', '')
      }
      r = NewWxPay::Result.new(Hash.from_xml(invoke_remote("/pay/getsignkey", xmlify_payload(params))))
    ...
    def self.invoke_unifiedorder(params, options = {})
      params = {
        appid: options.delete(:appid) || NewWxPay.appid,
        mch_id: options.delete(:mch_id) || NewWxPay.mch_id,
        key: options.delete(:key) || NewWxPay.key,
        nonce_str: SecureRandom.uuid.tr('-', '')
      }.merge(params)
      ...
      r = NewWxPay::Result.new(Hash.from_xml(invoke_remote("/pay/unifiedorder", make_payload(params), options)))
    ...
    def self.invoke_closeorder(params, options = {})
      ...
      r = NewWxPay::Result.new(Hash.from_xml(invoke_remote("/pay/closeorder", make_payload(params), options)))
    ...
    def self.generate_app_pay_req(params, options = {})
      params = {
        appid: options.delete(:appid) || NewWxPay.appid,
        partnerid: options.delete(:mch_id) || NewWxPay.mch_id,
        key: options.delete(:key) || NewWxPay.key,
      ...
      params[:sign] = NewWxPay::Sign.generate(params)
    ...
    def self.generate_js_pay_req(params, options = {})
      ...
      params[:paySign] = NewWxPay::Sign.generate(params)
      params
    end
    ...
    def self.invoke_refund(params, options = {})
      ...
      warn("NewWxPay Warn: missing required option: out_trade_no or transaction_id must have one") if ([:out_trade_no, :transaction_id] & params.keys) == []

      options = {
        ssl_client_cert: options.delete(:apiclient_cert) || NewWxPay.apiclient_cert,
        ssl_client_key: options.delete(:apiclient_key) || NewWxPay.apiclient_key,
        verify_ssl: OpenSSL::SSL::VERIFY_NONE
      }.merge(options)

      r = NewWxPay::Result.new(Hash.from_xml(invoke_remote("/secapi/pay/refund", make_payload(params), options)))
    ...
    def self.refund_query(params, options = {})
      ...
      r = NewWxPay::Result.new(Hash.from_xml(invoke_remote("/pay/refundquery", make_payload(params), options)))
    ...
    def self.invoke_transfer(params, options = {})
      params = {
        mch_appid: options.delete(:appid) || NewWxPay.appid,
        mchid: options.delete(:mch_id) || NewWxPay.mch_id,
        nonce_str: SecureRandom.uuid.tr('-', ''),
        key: options.delete(:key) || NewWxPay.key
      }.merge(params)
      ...
      r = NewWxPay::Result.new(Hash.from_xml(invoke_remote("/mmpaymkttransfers/promotion/transfers", make_payload(params), options)))
    ...
    def self.gettransferinfo(params, options = {})
      ...
      r = NewWxPay::Result.new(Hash.from_xml(invoke_remote("/mmpaymkttransfers/gettransferinfo", make_payload(params), options)))
    ...
    def self.risk_get_public_key(options = {})
      ...
      r = NewWxPay::Result.new(Hash.from_xml(invoke_remote("/risk/getpublickey", make_payload(params), options)))
    ...
    def self.pay_bank(params, options = {})
      ...
      r = NewWxPay::Result.new(Hash.from_xml(invoke_remote("/mmpaysptrans/pay_bank", make_payload(params), options)))
    ...
    def self.query_bank(params, options = {})
      ...
      r = NewWxPay::Result.new(Hash.from_xml(invoke_remote("/mmpaysptrans/query_bank", make_payload(params), options)))
    ...
    def self.invoke_reverse(params, options = {})
      ...
      r = NewWxPay::Result.new(Hash.from_xml(invoke_remote("/secapi/pay/reverse", make_payload(params), options)))
    ...
    def self.invoke_micropay(params, options = {})
      ...
      r = NewWxPay::Result.new(Hash.from_xml(invoke_remote("/pay/micropay", make_payload(params), options)))
    ...
    def self.order_query(params, options = {})
      ...
      r = NewWxPay::Result.new(Hash.from_xml(invoke_remote("/pay/orderquery", make_payload(params), options)))
      check_required_options(params, ORDER_QUERY_REQUIRED_FIELDS)
    ...
    def self.download_fund_flow(params, options = {})
      ...
      r = invoke_remote("/pay/downloadfundflow", make_payload(params, NewWxPay::Sign::SIGN_TYPE_HMAC_SHA256), options)
    ...
    def self.sendgroupredpack(params, options={})
      params = {
        wxappid: options.delete(:appid) || NewWxPay.appid,
        mch_id: options.delete(:mch_id) || NewWxPay.mch_id,
        key: options.delete(:key) || NewWxPay.key,
        nonce_str: SecureRandom.uuid.tr('-', '')
      }.merge(params)
      ...
      r = NewWxPay::Result.new(Hash.from_xml(invoke_remote("/mmpaymkttransfers/sendgroupredpack", make_payload(params), options)))
    ...
    def self.sendredpack(params, options={})
      ...
      r = NewWxPay::Result.new(Hash.from_xml(invoke_remote("/mmpaymkttransfers/sendredpack", make_payload(params), options)))
    ...
    def self.gethbinfo(params, options = {})
      ...
      r = NewWxPay::Result.new(Hash.from_xml(invoke_remote("/mmpaymkttransfers/gethbinfo", make_payload(params), options)))
    ...
    def self.profitsharingaddreceiver(params, options = {})
      ...
      r = NewWxPay::Result.new(Hash.from_xml(invoke_remote("/pay/profitsharingaddreceiver", make_payload(params, NewWxPay::Sign::SIGN_TYPE_HMAC_SHA256), options)))
    ...
    def self.profitsharingremovereceiver(params, options = {})
      ...
      r = NewWxPay::Result.new(Hash.from_xml(invoke_remote("/pay/profitsharingremovereceiver", make_payload(params, NewWxPay::Sign::SIGN_TYPE_HMAC_SHA256), options)))
    ...
    def self.profitsharing(params, options = {})
      ...
      r = NewWxPay::Result.new(Hash.from_xml(invoke_remote("/secapi/pay/profitsharing", make_payload(params, NewWxPay::Sign::SIGN_TYPE_HMAC_SHA256), options)))
    ...
    class << self
      ...
      def get_gateway_url
        return SANDBOX_GATEWAY_URL if NewWxPay.sandbox_mode?
        GATEWAY_URL
      end

      def check_required_options(options, names)
        return unless NewWxPay.debug_mode?
        names.each do |name|
          warn("NewWxPay Warn: missing required option: #{name}") unless options.has_key?(name)
        end
      end

      def xmlify_payload(params, sign_type = NewWxPay::Sign::SIGN_TYPE_MD5)
        sign = NewWxPay::Sign.generate(params, sign_type)
        "<xml>#{params.except(:key).sort.map { |k, v| "<#{k}>#{v}</#{k}>" }.join}<sign>#{sign}</sign></xml>"
      end

      def make_payload(params, sign_type = NewWxPay::Sign::SIGN_TYPE_MD5)
        # TODO: Move this out
        if NewWxPay.sandbox_mode? && !NewWxPay.manual_get_sandbox_key?
          r = get_sandbox_signkey
          if r['return_code'] == NewWxPay::Result::SUCCESS_FLAG
            params = params.merge(
              mch_id: r['mch_id'] || NewWxPay.mch_id,
              key: r['sandbox_signkey']
            )
          else
            warn("NewWxPay Warn: fetch sandbox sign key failed #{r['return_msg']}")
          end
        end
